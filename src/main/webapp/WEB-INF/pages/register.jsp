...
<body>
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					novalidate="novalidate" action="${pageContext.request.contextPath}/register" 
					onsubmit="return check()">
							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20" onkeyup="checkName()"><span id='namecheckSpan'></span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="password" name="passwordEnsure" class="text"
						...
						<div class="login">
							...
							<dl>
								...
								<dd>
									立即登录即可体验在线购物！ <a
										href="${pageContext.request.contextPath}/会员登录.htm">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
	...
	<div id="_my97DP"
		...
		<iframe style="width: 190px; height: 191px;"
			src="${pageContext.request.contextPath}/会员注册 - Powered By Mango Team_files/My97DatePicker.htm"
       ...
       success:function(result){
            console.log(result);
       		if (result.status==0) {
				...
				$("#namecheckSpan").css("color","green");
				$("#namecheckSpan").text("可以使用");
				
			} else {
				$("#namecheckSpan").css("color","red");
				$("#namecheckSpan").text("用户名不可使用");
			}
         }
       });
    }
