   ...
   <div class="container cart">
		...
		<div class="span24">
			...
			<form id="orderForm" action="./order_payOrder.action" method="post">
				...
				<div class="span24">
					<p>
							收货地址：<input name="addr" type="text" value="${user.addr }" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text" value="${user.username }" style="width:150px" />
								<br /> 
							联系方式：<input name="phone" type="text"value="${user.phone }" style="width:150px" />
						...
						<p style="text-align:right">
							<a href="${pageContext.request.contextPath}/toPaySuccessPage?oid=${oid }">
